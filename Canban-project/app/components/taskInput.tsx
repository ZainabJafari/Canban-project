...
const TaskPopup: React.FC<TaskPopupProps> = (props) => {
  const [taskTitle, setTaskTitle] = useState(""); // State för att hålla titeln på uppgiften
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    fetch("https://dummyjson.com/todos/add", {
      ...
      body: JSON.stringify({
        todo: taskTitle, // Skicka titeln på uppgiften från state
        completed: false,
        userId: 5,
      }),
    })
      .then((res) => res.json())
      .then((data) => {
        console.log("Uppgift tillagd:", data); // Logga svaret från servern
        // Återställ titeln till tom sträng efter att uppgiften lagts till
        setTaskTitle("");
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-5">
            ...
            <input
              ...
              value={taskTitle} // Koppla värdet av input till state
              onChange={(e) => setTaskTitle(e.target.value)} // Uppdatera state när användaren skriver
